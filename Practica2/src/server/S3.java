...
public class S3 extends Thread {
    ...
    public S3(int puerto, String nombServer,double vien, double pr) {
        try {
            this.puerto = puerto;
            this.vien = vien;
            this.pr = pr;
    ...
    public S3(double vien , double pr) {
        this.vien=vien;
        this.pr=pr;
    }
    ...
    public void serializarJSON(String nombreServer) {
        ...
        jsonObject.addProperty("Viento", vien);
        jsonObject.addProperty("Precipitación", pr);
